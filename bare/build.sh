...
DEBIAN_FRONTEND=noninteractive apt-get update 2>&1 >/dev/null && DEBIAN_FRONTEND=noninteractive apt-get install -y python3-diskimage-builder qemu-utils 2>&1 >/dev/null
